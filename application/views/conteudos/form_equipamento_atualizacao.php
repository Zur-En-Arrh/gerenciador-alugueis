<?php echo form_open('equipamento/atualizacao', '', $hidden); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <?php echo form_dropdown(array('name' => 'status', 'class' => 'form-control', 'id' => 'sltStatus', 'required' => 'required'), $opcoes, $obj->status); ?>
                </div>
            </div>
